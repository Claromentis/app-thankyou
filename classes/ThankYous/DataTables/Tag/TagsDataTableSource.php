...
class TagsDataTableSource extends FilterDataTableSource
{
	...
	public function Data(SecurityContext $context, Parameters $params, TableFilter $filter)
	{
		...
		$tags_thankyou_total_uses = $this->api->GetTagsTotalThankYouUses([$order], $limit, $offset, null, null, $filters['thanked_user_ids'], $filters['date_range'], $filters['tags']);
	...
	public function Count(SecurityContext $context, Parameters $params, TableFilter $filters)
	{
		...
		return $this->api->GetTotalTags(null, $filters['date_range'], $filters['thanked_user_ids'], $filters['tags']);
	}
}
